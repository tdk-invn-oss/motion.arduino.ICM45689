...
#define EDMP_MAG_BIAS_SHIFT 5

#define EDMP_MAG_FAST_COVARIANCE_CONV_THR_DEFAULT  (EDMP_COV_MAX_SELECTED_ACCURACY_2 + 1)
#define EDMP_MAG_STUCK_COVARIANCE_CONV_THR_DEFAULT (EDMP_COV_MAX_SELECTED_ACCURACY_3 + 1)
