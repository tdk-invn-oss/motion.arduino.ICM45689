...
typedef struct {
	uint8_t int_status_mask_pin_ext2_det                                           : 1;
	uint8_t int_status_mask_pin_ff_det                                             : 1;
	uint8_t int_status_mask_pin_ext1_det                                           : 1;
	uint8_t int_status_mask_pin_ext0_det                                           : 1;
...
typedef struct {
	uint8_t resv_2                                                                 : 1;
	uint8_t int_status_mask_pin_ext6_det                                           : 1;
	uint8_t int_status_mask_pin_ext5_det                                           : 1;
	uint8_t int_status_mask_pin_sa_done                                            : 1;
	uint8_t resv_1                                                                 : 1;
	uint8_t int_status_mask_pin_selftest_done                                      : 1;
	uint8_t int_status_mask_pin_ext4_det                                           : 1;
	uint8_t int_status_mask_pin_ext3_det                                           : 1;
} int_apex_config1_t;

#define INT_APEX_STATUS0                                                        0x3b
typedef struct {
	uint8_t int_status_ext2_det                                                    : 1;
	uint8_t int_status_ff_det                                                      : 1;
	uint8_t int_status_ext1_det                                                    : 1;
	uint8_t int_status_ext0_det                                                    : 1;
...
typedef struct {
	uint8_t resv_2                                                                 : 1;
	uint8_t int_status_ext6_det                                                    : 1;
	uint8_t int_status_ext5_det                                                    : 1;
	uint8_t int_status_sa_done                                                     : 1;
	uint8_t resv_1                                                                 : 1;
	uint8_t int_status_selftest_done                                               : 1;
	uint8_t int_status_ext4_det                                                    : 1;
	uint8_t int_status_ext3_det                                                    : 1;
} int_apex_status1_t;
